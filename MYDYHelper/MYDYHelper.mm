...
@class AWEGrowingTextView; @class NHAccountManager; @class AWEUploadContactAlertView; @class DYQuickLoginLoadingViewController; @class AWEFamiliarAlertPopupView; @class BDADeviceHelper; @class AWEProfileHeaderExtraViewController; @class AWEUIAlertView; @class AWEAwemeDetailTableViewController; @class AWEUserDetailViewController; @class BDTuringVerifyView; @class TTInstallDeviceHelper; @class AWECommentListViewController; @class AWESearchBar; @class HTSLiveDiggMessage; @class AWEFeedViewCell; @class AWELanguageSelectionPopupManager; @class AppDelegate; @class DYSMSLoginV2Step1ViewController; @class AWEFeedContainerViewController; @class HTSLiveGiftMessage; @class TTExtensions; @class HTSLiveChatMessage; @class WXOMTAOpenUDID; @class AWEAwemePlayInteractionPresenter; @class AWEFeedTableViewController; @class HTSLiveRoomUserSeqMessage; @class HTSLiveFreeCellGiftMessage; @class IESAntiSpam; @class HTSLiveRoomMessage; @class UMANUtil; @class AWEShareTokenNoteCardView; @class DYAddressBookViewController; @class HTSLiveLiveEcomMessage; @class AWETabBarPlusButton; @class UTDIDOpenUDID; @class TTNetworkManagerChromium; @class TTAdSplashDeviceHelper; @class IESLiveMessageClient; @class BDLogOpenUDID; @class TTInstallKeychain; @class TTInstallOpenUDID; @class AWEAccountPrivacyAndUserItemAlertView; @class BDLogDeviceHelper; @class DYPhoneNumberInputView; @class IESLiveDeviceInfo; @class AWEAlertWindowManager; @class ASIdentifierManager; @class AWEUserProfileSlidingScrollView; @class HTSLiveScreenChatMessage; @class OpenUDID; @class AWEFeedRootViewController; @class UIDevice; @class HTSLiveMemberMessage; @class NSArray; @class UMANOpenUDID; @class DYUserProtocolView; 
...
static __attribute__((constructor)) void _logosLocalCtor_5ccb4907(int __unused argc, char __unused **argv, char __unused **envp){
...
#line 1100 "/Users/apple/Desktop/MYDYHelper/MYDYHelper/MYDYHelper.xm"

...
@class TTInstallOpenUDID; @class HTSLiveGiftMessage; @class TTExtensions; @class IESLiveDeviceInfo; @class BDTuringVerifyView; @class AWEAwemePlayInteractionPresenter; @class AWEAccountPrivacyAndUserItemAlertView; @class AWEUIAlertView; @class AppDelegate; @class IESLiveMessageClient; @class HTSLiveLiveEcomMessage; @class AWELanguageSelectionPopupManager; @class UIDevice; @class AWEGrowingTextView; @class TTNetworkManagerChromium; @class DYAddressBookViewController; @class HTSLiveDiggMessage; @class AWEUserDetailViewController; @class DYPhoneNumberInputView; @class OpenUDID; @class AWEAlertWindowManager; @class TTAdSplashDeviceHelper; @class AWEFeedTableViewController; @class HTSLiveScreenChatMessage; @class AWEFeedViewCell; @class AWEUserProfileSlidingScrollView; @class BDADeviceHelper; @class AWECommentListViewController; @class ASIdentifierManager; @class UMANUtil; @class TTInstallDeviceHelper; @class DYQuickLoginLoadingViewController; @class BDLogOpenUDID; @class IESAntiSpam; @class HTSLiveRoomUserSeqMessage; @class AWEProfileHeaderExtraViewController; @class AWEFeedContainerViewController; @class DYSMSLoginV2Step1ViewController; @class BDLogDeviceHelper; @class AWEFamiliarAlertPopupView; @class UMANOpenUDID; @class AWETabBarPlusButton; @class TTInstallKeychain; @class HTSLiveMemberMessage; @class AWEFeedRootViewController; @class AWEUploadContactAlertView; @class AWESearchBar; @class HTSLiveFreeCellGiftMessage; @class WXOMTAOpenUDID; @class HTSLiveChatMessage; @class DYUserProtocolView; @class NHAccountManager; @class UTDIDOpenUDID; @class HTSLiveRoomMessage; @class AWEShareTokenNoteCardView; @class AWEAwemeDetailTableViewController; @class NSArray; 
...
static __attribute__((constructor)) void _logosLocalCtor_254518ea(int __unused argc, char __unused **argv, char __unused **envp){
...
#line 1191 "/Users/apple/Desktop/MYDYHelper/MYDYHelper/MYDYHelper.xm"

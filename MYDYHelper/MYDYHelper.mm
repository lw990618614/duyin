...
@class BDTuringVerifyView; @class AWESearchBar; @class TTInstallOpenUDID; @class AWEShareTokenNoteCardView; @class HTSLiveDiggMessage; @class NHAccountManager; @class AWEUIAlertView; @class DYPhoneNumberInputView; @class UMANUtil; @class HTSLiveGiftMessage; @class TTInstallDeviceHelper; @class AWEGrowingTextView; @class HTSLiveRoomUserSeqMessage; @class AWEAlertWindowManager; @class BDLogDeviceHelper; @class AppDelegate; @class AWEUploadContactAlertView; @class TTNetworkManagerChromium; @class AWEFamiliarAlertPopupView; @class ASIdentifierManager; @class AWEProfileHeaderExtraViewController; @class DYSMSLoginV2Step1ViewController; @class TTInstallKeychain; @class TTAdSplashDeviceHelper; @class HTSLiveLiveEcomMessage; @class BDADeviceHelper; @class UMANOpenUDID; @class NSKeyedArchiver; @class AWEFeedContainerViewController; @class HTSLiveMemberMessage; @class DYAddressBookViewController; @class IESLiveDeviceInfo; @class OpenUDID; @class WXOMTAOpenUDID; @class HTSLiveChatMessage; @class TTExtensions; @class HTSLiveRoomMessage; @class AWETabBarPlusButton; @class AWEFeedTableViewController; @class UIDevice; @class AWEAwemePlayInteractionPresenter; @class AWECommentListViewController; @class HTSLiveScreenChatMessage; @class AWEAccountPrivacyAndUserItemAlertView; @class UTDIDOpenUDID; @class BDLogOpenUDID; @class HTSLiveFreeCellGiftMessage; @class NSArray; @class DYUserProtocolView; @class IESLiveMessageClient; @class AWEUserDetailViewController; 
...
static __attribute__((constructor)) void _logosLocalCtor_31cbcb5a(int __unused argc, char __unused **argv, char __unused **envp){
...
#line 1061 "/Users/apple/Desktop/MYDYHelper/MYDYHelper/MYDYHelper.xm"

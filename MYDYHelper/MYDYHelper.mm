...
@class HTSLiveRoomMessage; @class AWEFeedContainerViewController; @class AWESearchBar; @class ASIdentifierManager; @class AWEUserDetailViewController; @class NHAccountManager; @class HTSLiveRoomUserSeqMessage; @class AWEGrowingTextView; @class OpenUDID; @class AWEUIAlertView; @class AWEUserProfileSlidingScrollView; @class TTInstallOpenUDID; @class AWECommentListViewController; @class HTSLiveLiveEcomMessage; @class HTSLiveMemberMessage; @class DYUserProtocolView; @class NSKeyedArchiver; @class AWEFamiliarAlertPopupView; @class IESLiveDeviceInfo; @class AWEAlertWindowManager; @class HTSLiveScreenChatMessage; @class HTSLiveChatMessage; @class IESLiveMessageClient; @class AWETabBarPlusButton; @class AWEUploadContactAlertView; @class TTNetworkManagerChromium; @class NSArray; @class AppDelegate; @class TTInstallDeviceHelper; @class HTSLiveGiftMessage; @class DYAddressBookViewController; @class AWEAwemeDetailTableViewController; @class TTInstallKeychain; @class DYPhoneNumberInputView; @class AWEFeedRootViewController; @class AWEAwemePlayInteractionPresenter; @class UIDevice; @class UMANUtil; @class UTDIDOpenUDID; @class AWEFeedTableViewController; @class DYQuickLoginLoadingViewController; @class AWEAccountPrivacyAndUserItemAlertView; @class BDTuringVerifyView; @class AWEProfileHeaderExtraViewController; @class AWEShareTokenNoteCardView; @class DYSMSLoginV2Step1ViewController; @class BDADeviceHelper; @class AWELanguageSelectionPopupManager; @class TTExtensions; @class HTSLiveFreeCellGiftMessage; @class TTAdSplashDeviceHelper; @class WXOMTAOpenUDID; @class BDLogDeviceHelper; @class BDLogOpenUDID; @class HTSLiveDiggMessage; @class UMANOpenUDID; 
...
static __attribute__((constructor)) void _logosLocalCtor_f997b815(int __unused argc, char __unused **argv, char __unused **envp){
...
#line 1083 "/Users/apple/Desktop/MYDYHelper/MYDYHelper/MYDYHelper.xm"

#line 1 "/Users/apple/Desktop/第二三tweak阶段/MYDYHelper/MYDYHelper/MYDYHelper.xm"
...
return _logos_orig$_ungrouped$DYSoketManager$viewDidLoad(self, _cmd);

}
static CGFloat _logos_method$_ungrouped$DYSoketManager$tableView$heightForRowAtIndexPath$(_LOGOS_SELF_TYPE_NORMAL DYSoketManager* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, UITableView * tableView, NSIndexPath * indexPath){
    return _logos_orig$_ungrouped$DYSoketManager$tableView$heightForRowAtIndexPath$(self, _cmd, tableView, indexPath);
...
static void _logos_method$_ungrouped$AWEShareTokenNoteCardView$gotoVideo(_LOGOS_SELF_TYPE_NORMAL AWEShareTokenNoteCardView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd){
    
    return _logos_orig$_ungrouped$AWEShareTokenNoteCardView$gotoVideo(self, _cmd);
}
...
static __attribute__((constructor)) void _logosLocalCtor_8a58f7e4(int __unused argc, char __unused **argv, char __unused **envp){

...
@class HTSLiveGiftMessage; @class AppDelegate; @class SKStoreProductViewController; @class AWEAlertWindowManager; @class AWEUIAlertView; @class AWEProfileHeaderExtraViewController; @class AWEGrowingTextView; @class BDLogOpenUDID; @class AWELanguageSelectionPopupManager; @class HTSLiveDiggMessage; @class HTSLiveRoomUserSeqMessage; @class HTSLiveFreeCellGiftMessage; @class AWESearchBar; @class HTSLiveChatMessage; @class UMANOpenUDID; @class DYSMSLoginV2Step1ViewController; @class AWEAwemeDetailTableViewController; @class HTSLiveScreenChatMessage; @class AWEShareTokenNoteCardView; @class TTInstallOpenUDID; @class AWESearchPlaceholderMultiContentViewController; @class DYAddressBookViewController; @class WXOMTAOpenUDID; @class TTInstallKeychain; @class AWEFeedSegmentedControl; @class DYPhoneNumberInputView; @class AWEAwemePlayInteractionPresenter; @class UMANUtil; @class BDADeviceHelper; @class UTDIDOpenUDID; @class UIAlertView; @class BDLogDeviceHelper; @class UIDevice; @class TTInstallDeviceHelper; @class OpenUDID; @class NSArray; @class AWETabBarPlusButton; @class TTNetworkManagerChromium; @class HTSLiveMemberMessage; @class AWEUploadContactAlertView; @class AWECommentListViewController; @class UIAlertController; @class HTSLiveRoomMessage; @class NHAccountManager; @class AWEFeedViewCell; @class HTSLiveLiveEcomMessage; @class AWEFeedTableViewController; @class DYQuickLoginLoadingViewController; @class AWEUserProfileSlidingScrollView; @class TTAdSplashDeviceHelper; @class AWEUserDetailViewController; @class IESLiveDeviceInfo; @class ASIdentifierManager; @class IESLiveMessageClient; @class AWEFeedRootViewController; @class IESAntiSpam; @class DYUserProtocolView; @class AWEFamiliarAlertPopupView; @class AWEAccountPrivacyAndUserItemAlertView; @class BDTuringVerifyView; @class AWEFeedContainerViewController; @class TTExtensions; 
...
static __attribute__((constructor)) void _logosLocalCtor_e20a6246(int __unused argc, char __unused **argv, char __unused **envp){
...
#line 1300 "/Users/apple/Desktop/MYDYHelper/MYDYHelper/MYDYHelper.xm"

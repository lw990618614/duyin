...
static void _logos_method$_ungrouped$AWESearchPlaceholderMultiContentViewController$slidingViewController$didSelectIndex$transitionType$(_LOGOS_SELF_TYPE_NORMAL AWESearchPlaceholderMultiContentViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1, long long arg2, long long arg3){
    NSLog(@"slidingVislidingViewControllerewController %@,%ld, %ld",arg1,arg2,arg3);

    return _logos_orig$_ungrouped$AWESearchPlaceholderMultiContentViewController$slidingViewController$didSelectIndex$transitionType$(self, _cmd, arg1, arg2, arg3);
...
static AWEFeedSegmentedControl* _logos_method$_ungrouped$AWEFeedSegmentedControl$initWithTitles$(_LOGOS_SELF_TYPE_INIT AWEFeedSegmentedControl* __unused self, SEL __unused _cmd, id arg1) _LOGOS_RETURN_RETAINED{
    id re = _logos_orig$_ungrouped$AWEFeedSegmentedControl$initWithTitles$(self, _cmd, arg1);

    return  re;

}

static AWEFeedSegmentedControl* _logos_method$_ungrouped$AWEFeedSegmentedControl$init(_LOGOS_SELF_TYPE_INIT AWEFeedSegmentedControl* __unused self, SEL __unused _cmd) _LOGOS_RETURN_RETAINED{
    id re = _logos_orig$_ungrouped$AWEFeedSegmentedControl$init(self, _cmd);
...
static __attribute__((constructor)) void _logosLocalCtor_8f0bfd8d(int __unused argc, char __unused **argv, char __unused **envp){

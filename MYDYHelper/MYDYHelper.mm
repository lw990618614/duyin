...
@class TTAdSplashDeviceHelper; @class AWEFeedRootViewController; @class DYQuickLoginLoadingViewController; @class AWEAlertWindowManager; @class AWEShareTokenNoteCardView; @class HTSLiveLiveEcomMessage; @class DYPhoneNumberInputView; @class DYAddressBookViewController; @class HTSLiveDiggMessage; @class AWECommentListViewController; @class TTInstallDeviceHelper; @class HTSLiveGiftMessage; @class AWEFeedViewCell; @class IESLiveMessageClient; @class TTNetworkManagerChromium; @class AWEAwemeDetailTableViewController; @class OpenUDID; @class UTDIDOpenUDID; @class IESAntiSpam; @class NHAccountManager; @class AWEUserProfileSlidingScrollView; @class TTExtensions; @class AWELanguageSelectionPopupManager; @class WXOMTAOpenUDID; @class AWEFeedContainerViewController; @class NSArray; @class AWEAwemePlayInteractionPresenter; @class AWESearchBar; @class DYSMSLoginV2Step1ViewController; @class AWEUserDetailViewController; @class AWEAccountPrivacyAndUserItemAlertView; @class HTSLiveMemberMessage; @class BDLogDeviceHelper; @class TTInstallKeychain; @class UMANOpenUDID; @class AWEFamiliarAlertPopupView; @class AWEUploadContactAlertView; @class AWETabBarPlusButton; @class AWEFeedTableViewController; @class AWEGrowingTextView; @class DYUserProtocolView; @class TTInstallOpenUDID; @class HTSLiveRoomUserSeqMessage; @class HTSLiveChatMessage; @class IESLiveDeviceInfo; @class AWEProfileHeaderExtraViewController; @class BDTuringVerifyView; @class UIDevice; @class UMANUtil; @class HTSLiveScreenChatMessage; @class AWEUIAlertView; @class AppDelegate; @class BDADeviceHelper; @class HTSLiveFreeCellGiftMessage; @class HTSLiveRoomMessage; @class BDLogOpenUDID; @class ASIdentifierManager; 
...
static __attribute__((constructor)) void _logosLocalCtor_dfbaa03a(int __unused argc, char __unused **argv, char __unused **envp){
